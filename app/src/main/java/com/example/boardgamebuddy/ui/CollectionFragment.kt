...
class CollectionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Setup RecyclerView
        listView = view.findViewById(R.id.collectionRecyclerView)
    ...
    private fun fetchCollectionGames() {
            ...
            db.collection("users").document(currentUser.uid)
                ...
                .addOnSuccessListener { result ->
                    ...
                    if (favoriteGameIds.isNotEmpty()) {
                        ...
                        Toast.makeText(requireContext(), "No games in your collection found", Toast.LENGTH_SHORT).show()
                    }
                }
                .addOnFailureListener { exception ->
                    Toast.makeText(requireContext(), "Error getting games in collection: $exception", Toast.LENGTH_SHORT).show()
                }
        } else {
            Toast.makeText(requireContext(), "Please log in to see games in your collection", Toast.LENGTH_SHORT).show()
        }
    }
